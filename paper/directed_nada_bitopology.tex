...
\texttt{mathlib4}~\cite{mathlib} with zero \texttt{sorry}s, depending
on exactly one explicitly declared axiom corresponding to the
finite-space form of the classical McCord--Stong
...
\texttt{mathlib4}~\cite{mathlib}, which contains zero \texttt{sorry}
and depends on exactly one user-declared axiom
